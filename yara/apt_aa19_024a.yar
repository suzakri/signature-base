...
rule APT_MAL_DNS_Hijacking_Campaign_AA19_024A {
   ...
   strings:
      ...
      $s3 = "Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko" fullword ascii // Suspect user-agent?
   ...
   condition:
      uint16(0) == 0x5a4d and filesize < 1000KB and 2 of them // 0x5a4d = MZ magic bytes, AKA a Windows PE
}
